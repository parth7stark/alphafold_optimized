...
MAX_SEQ="${15:-512}"
MAX_EXTRA_SEQ="${16:-5120}"
NUM_ENSEMBLE="${17:-1}"
NUM_RECYCLES="${18:-3}"
RECYCLE_EARLY="${19:-0.5}"
...
echo "JOB_NAME $1; MACHINE_NAME $2; FASTA_FILES $3; MAX_TEMPLATE_DATE $4; USE_PRECOMPUTED_MSAS $5; MODEL_PRESET $6; DB_PRESEET $7; NUM_PREDS_PER_MODEL $8; MODELS_TO_RELAX $9; GPU_DEVICES ${10}; PERFORM_MD_ONLY ${11}; USE_AMBER ${12} USE_DROPOUT ${13} USE_BFLOAT16 ${14} MAX_SEQ ${15} MAX_EXTRA_SEQ ${16} NUM_ENSEMBLE ${17} NUM_RECYCLES ${18} RECYCLE_EARLY ${19} are chosen..."
